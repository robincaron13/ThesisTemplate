...
\newcommand{\PhDTitleFR}{Ecoulement anisotropique charmé et beauté dans les collisions ultra-relativistique d'ions lourds avec ALICE au LHC}													%% Titre de la thèse en français / Thesis title in french
...
\newcommand{\PhDTitleEN}{Charm and beauty anisotropic flow in ultra-relativistic heavy-ions collisions with ALICE at the LHC}													%% Titre de la thèse en anglais / Thesis title in english
...
\begin{textblock*}{61mm}(3mm,3mm)
	\noindent\includegraphics[height=24mm]{media/ed/PHENIICS.jpeg}
\end{textblock*}
