...
\newcommand{\PhDTitle}{Charm and beauty anisotropic flow in ultra-relativistic heavy-ions collisions with ALICE at the LHC} 	%% Titre de la thèse / Thesis title
\newcommand{\PhDname}{Robin Albert André Caron} 															%% Civilité, nom et prénom /  Civility, first name and name 
...
\newcommand{\ecodoctitle}{Particles, Hadrons, Energy, Nuclei, Intrumentation, Imaging, Cosmos et Simulation} 													%% Nom de l'ED. Voir site de l'Université Paris-Saclay / Full name of Doctoral School. See Université Paris-Saclay website
...
\newcommand{\PhDspeciality}{Physique Hadronique} 										%% Spécialité de doctorat / Speciality 
...
\newcommand{\defensedate}{22/09/2021} 															%% Date de soutenance / Date of defense
...
%\newcommand{\logoEtt}{Logo_CEA_Saclay}  																%% Logo de l'établissement de soutenance. Le nom du fichier correspond au sigle de l'établissement /  Institution logo. Filename correspond to institution acronym : AGRO, CENTSUP, ENS, ENSAE, ENSTA, HEC, IOGS, TPT, TSP, UEVE, UPSUD, UVSQ, X 
...
\begin{textblock}{1}(\hpostt,\vpostt)
	...
	\hspace{6cm}
	\includegraphics[scale=0.08]{media/etab/irfu.jpg}
\end{textblock}
