...
\newcommand\BackgroundPic{%
	\put(0,0){%
		\parbox[b][\paperheight]{\paperwidth}{%
			%\includegraphics[height=0.45\paperheight]{Logo_PSud}%
			\vfill
		}
	}
}
...
\newgeometry{top=2cm, bottom=1cm, left=2cm, right=1.5cm}
\AddToShipoutPicture*{\BackgroundPic}
\AddToShipoutPicture*{\EtiquetteThese}
  \begin{titlepage}
  \centering
    \includegraphics[width=0.175\textwidth]{media/logos/ALICE-logo}
      \hfill
      \includegraphics[width=0.15\textwidth]{media/logos/Logo_CEA_Saclay}
      \includegraphics[width=0.15\textwidth]{media/logos/Logo_PSud}\\
    \vspace{1cm}
      {\Large \@ED}\\
    \vspace{1cm}
      {\huge 
